...
var globalSeed = 133;
var globalLoopContinueRate = 5;
var globalCodeLength = 10000;
var globalTapeLength = 1024;
var globalLoopStep = 100;
var globalLoopSkipCreateRate = 3;
var globalLoopInnerStartLow = 100;
var globalLoopInnerStartHigh = 100;
var globalLoopInnerEndLow = 100;
var globalLoopInnerEndHigh = 100;
var globalLoopOuterEndLow = 50;
var globalLoopOuterEndHigh = 50;
var globalLongestNote = 4;
var globalProbabilityInversionSections = 10;
var globalRange = 0;
var globalTempo = 112;
var globalRhythmSixteenth = false;
var globalRhythmTripletEighth = true;
var globalRhythmEighth = true;
var globalRhythmTripletQuarter = true;
...
var random = createMultiplyWithCarryPRNG(globalSeed);
...
function createDurations () {
  ...
  if (globalRhythmTripletQuarter) durations.push(durationLCM * 1 / 6);
...
function planLoops () {
  ...
  var d = c + globalLoopInnerEndHigh;
  var e = d + globalLoopOuterEndLow;
  ...
  {
    if(random.nextIntBetween(0, globalLoopSkipCreateRate))
      continue;
...
function performInstruction () {
  ...
  if (i === "MoveForward") dataPointer++;
    ...
    if (i !== "WhileEnd" || random.nextIntBetween(0, globalLoopContinueRate)) {
...
function createPiece () {
  ...
  var i;
  for (i = 0; i < globalCodeLength; i++) { instructions[i] = 0; }
