...
////////////////////////////////////////////////////////////////////////////////
  ...
  this.PiecePlayer = function PiecePlayer() {
    ...
    this.configureAudioGraph = function (callback) {
      var that = this, reverbUrl;
      this.masterGain = this.context.createGain();
      this.masterGain.gain.value = this.masterVolume;
      this.masterGain.connect(this.context.destination);

      window.onbeforeunload = function () {
        that.shutdownGracefully();
      };
      ...
      reverbUrl = 'http://reverbjs.org/Library/' +
    ...
    this.muteConcert = function (muted) {
      var g = muted ? 0 : this.concertVolume, t = this.context.currentTime;
    ...
    this.muteGenerated = function (muted) {
      var g = muted ? 0 : this.masterVolume, t = this.context.currentTime;
...
/* To use this piece in an HTML file:

1) Add this to the head tag (reverb support):

&lt;script src="http://reverbjs.org/reverb.js"
  type="text/javascript" charset="utf-8"&gt;
&lt;/script&gt;

2) Embed the present document in a script tag.

3) Trigger the piece from somewhere like this:

var piece = new window.PiecePlayer();
piece.start();
